...
<head>
    ...
    <title>Manager Assign Shift</title>
                        ...
                        <form method="post" action="">
                            <div class="row mt-0 col-md-12">
                                ...
                                <div class="col-xl-6 col-lg-6 col-xs-12">
                                    <label for="citSelection" class="font-weight-bold">City:</label>
                                ...
                                <!--                                date selection-->
                                <div class="col-xl-6 col-lg-6 col-xs-12">
                                    <label for="employeeDesiredDay" class="font-weight-bold">Preferred Day:</label><br/>
                                    <input type="checkbox" name="employeeDesiredDay" value="Mon"> Monday
                                    <input type="checkbox" name="employeeDesiredDay" value="Tue"> Tuesday
                                    <input type="checkbox" name="employeeDesiredDay" value="Wed"> Wednesday
                                    <input type="checkbox" name="employeeDesiredDay" value="Thur"> Thursday<br/>
                                    <input type="checkbox" name="employeeDesiredDay" value="Fri"> Friday
                                    <input type="checkbox" name="employeeDesiredDay" value="Sat"> Saturday
                                    <input type="checkbox" name="employeeDesiredDay" value="Sun"> Sunday&nbsp;&nbsp;&nbsp;&nbsp;
                                    <input type="checkbox" id="selectAllDesiredDays"> All
                                </div>
                            </div>
                            ...
                            <div class="row mt-1 col-md-12">
                                ...
                                <div class="col-xl-4 col-lg-4 col-xs-12">
                                    ...
                                    <input type="text" id="employeeId" class="form-control" name="employeeId" placeholder="Employee ID">
                                </div>
